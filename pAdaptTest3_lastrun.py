...
expName = 'pAdaptTest3'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\p-adapt-test3\\pAdaptTest3_lastrun.py',
...
for thisTrials2 in trials2:
    ...
    if taskVer == 3:
        if (trials2.thisN <= 24):
            ang = 7.5
            rtd = ang*(pi/180)
        elif (trials2.thisN > 24 and trials2.thisN <= 48):
            ang = 15
            rtd = ang*(pi/180)
        elif (trials2.thisN > 48 and trials2.thisN <= 72):
            ang = 22.5
            rtd = ang*(pi/180)
        else:
            ang = 30
